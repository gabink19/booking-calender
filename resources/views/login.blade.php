  ...
  <div class="container">
    <div class="login-header" style="display:flex;flex-direction:column;align-items:center;justify-content:center;margin-bottom:18px;">
      <div class="login-logo" style="margin-bottom:8px;">
        <img src="{{ asset('images/bv-logo.png') }}" alt="Logo Apartemen Bona Vista" style="height:48px;width:auto;display:block;margin:0 auto;">
      </div>
      <div>
    ...
    document.getElementById('loginForm').addEventListener('submit', function(e) {
      ...
      if (!username || !password) {
        ...
        Swal.fire({
          icon: 'warning',
          title: 'Lengkapi Data',
          text: 'No. HP/ID Pengguna dan password wajib diisi.',
          confirmButtonColor: '#6366f1'
        });
      }
    });
